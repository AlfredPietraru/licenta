...
public:     
    ...
    double get_rgbd_reprojection_error(KeyFrame *kf, MapPoint *mp, Sophus::SE3d &pose, Feature* feature, double chi2);
    double get_monocular_reprojection_error(KeyFrame *kf, MapPoint *mp, Sophus::SE3d &pose, Feature* feature, double chi2);
};
