...
void OrbMatcher::debug_reprojection(std::vector<MapPoint *> local_map, std::unordered_map<MapPoint *, Feature*> out_map, KeyFrame *first_kf, int window, int orb_descriptor_value) {
