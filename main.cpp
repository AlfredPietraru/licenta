...
void signalHandler(int signum) {
    ...
    if (slam != nullptr) {
        ...
        // slam->reader->write_all_entries(Sophus::SE3d(Eigen::Quaterniond(-0.4843, 0.6818, 0.5482, -0.0115), Eigen::Vector3d(1.3001, 0.6882, 1.5745)));
...
int main()
{
    ...
    // dt.translation_pose = Sophus::SE3d(Eigen::Quaterniond(-0.4843, 0.6818, 0.5482, -0.0115), Eigen::Vector3d(1.3001, 0.6882, 1.5745));
